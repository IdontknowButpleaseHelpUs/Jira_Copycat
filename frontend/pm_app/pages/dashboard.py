            ...
            rx.vstack(
                ...
                _form_row(
                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            rx.input(value=AppState.detail_grade, on_change=AppState.set_detail_grade, width="100px", size="2"),
                ...
                rx.text("Send back to assignee with a reason (sets status to Returned).", size="2", color="gray"),
                rx.hstack(
                    rx.input(
                    ...
                    rx.button("Return", on_click=AppState.submit_return_task, color_scheme="red", variant="solid", size="2"),
                    width="100%",
                    spacing="2",
                ),
                rx.divider(),
            ...
            rx.card(
                rx.vstack(
                    ...
                    _form_row(
                        ...
                        _labeled_input("Email", "name@company.com", AppState.member_email, AppState.set_member_email),
        ...
        rx.card(
            rx.vstack(
                ...
                _form_row(
                    ...
                    _labeled_input("Email", "you@school.edu", AppState.join_email, AppState.set_join_email),
